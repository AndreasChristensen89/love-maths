...
function checkAnswer() {
    ...
    if(isCorrect) {
        ...
        alert(`WRONG! ${userAnswer}? What a huge noob you are! Obviously it was ${calculatedCorrectAnswer[0]}!`);
...
function calculateCorrectAnswer() {
    let operand1 = parseInt(document.getElementById('operand1').innerText); //Using parseint due to string always returned, math not possible
